...
Trim size: 6" x 9". Interior page count: 220 (current typeset; the
spine math below moves with it — rerun before ordering the wrap).

## Spine width

| Paper | Formula | 220 pages |
|---|---|---|
| White (recommended for text-only) | pages × 0.002252" | 0.495" |
...
| Paper | Width | Height |
|---|---|---|
| White | 0.125 + 6 + 0.495 + 6 + 0.125 = **12.745"** | 9 + 0.25 = **9.25"** |
