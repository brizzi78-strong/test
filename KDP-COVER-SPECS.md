...
Trim size: 6" x 9". Interior page count: 231 (current typeset; the
spine math below moves with it — rerun before ordering the wrap).

## Spine width

| Paper | Formula | 231 pages |
|---|---|---|
| White (recommended for text-only) | pages × 0.002252" | 0.520" |
| Cream | pages × 0.0025" | 0.578" |

## Full wrap dimensions (includes 0.125" bleed on all outside edges)

| Paper | Width | Height |
|---|---|---|
| White | 0.125 + 6 + 0.520 + 6 + 0.125 = **12.770"** | 9 + 0.25 = **9.25"** |
| Cream | 0.125 + 6 + 0.578 + 6 + 0.125 = **12.828"** | **9.25"** |

At 300 DPI (white): 3831 × 2775 px.
...
The uploaded front-cover JPEG is 1320 × 1990 px (~220 DPI at 6x9). For print, ask
