...
Trim size: 6" x 9". Interior page count: 213 (current typeset; the
spine math below moves with it — rerun before ordering the wrap).

## Spine width

| Paper | Formula | 213 pages |
|---|---|---|
| White (recommended for text-only) | pages × 0.002252" | 0.48" |
...
| Paper | Width | Height |
|---|---|---|
| White | 0.125 + 6 + 0.48 + 6 + 0.125 = **12.73"** | 9 + 0.25 = **9.25"** |
