...
Trim size: 6" x 9". Interior page count: 227 (current typeset; the
spine math below moves with it — rerun before ordering the wrap).

## Spine width

| Paper | Formula | 227 pages |
|---|---|---|
| White (recommended for text-only) | pages × 0.002252" | 0.511" |
| Cream | pages × 0.0025" | 0.568" |

## Full wrap dimensions (includes 0.125" bleed on all outside edges)

| Paper | Width | Height |
|---|---|---|
| White | 0.125 + 6 + 0.511 + 6 + 0.125 = **12.761"** | 9 + 0.25 = **9.25"** |
| Cream | 0.125 + 6 + 0.568 + 6 + 0.125 = **12.818"** | **9.25"** |
