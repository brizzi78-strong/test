# HERE Token Launch Strategy

Launch plan for the HERE token: 250M fixed supply, Uniswap fair launch, trust-first design.
...
| Into the Uniswap pool | **200M HERE (80%)** | Screeners flag deployer-heavy tokens as rug risks; putting most of the supply in the locked pool is what "fair launch" looks like on-chain |
...
4. **Create the Uniswap pool** with 200M HERE + 2–5 ETH. The ETH amount sets the launch
   price; with 200M in the pool, 3 ETH implies a starting price of 0.000000015 ETH/HERE.
