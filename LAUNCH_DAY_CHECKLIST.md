...
- [ ] Send 50,000,000 HERE to the treasury wallet:
...
- [ ] Create the pool with 200,000,000 HERE + your chosen ETH amount (2–5 ETH)
- [ ] Double-check both amounts **before** confirming — the ratio sets the launch price
      and cannot be un-set (e.g. 3 ETH ÷ 200M = 0.000000015 ETH/HERE starting price)
...
- [ ] Watch for copycat/scam tokens using the HERE name; warn in your channels if any appear
