// Exports the solc standard JSON input for CP17.sol so the contract can
...
//
// Writes verification/CP17.solc-input.json and prints the exact compiler
...
const target = "project/contracts/CP17.sol";
...
const outFile = join(outDir, "CP17.solc-input.json");
...
console.log(`Contract to select after upload: ${target}:CP17`);
