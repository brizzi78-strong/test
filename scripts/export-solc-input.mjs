// Exports the solc standard JSON input for Cardinal.sol so the contract can
...
//
// Writes verification/Cardinal.solc-input.json and prints the exact compiler
...
const target = "project/contracts/Cardinal.sol";
...
const outFile = join(outDir, "Cardinal.solc-input.json");
...
console.log(`Contract to select after upload: ${target}:Cardinal`);
