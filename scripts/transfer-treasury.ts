// Checklist step 3: send 600,000,000 CARD to the treasury: 200M retained and
// 400M staged for the fee-exempt pool seed. Refuses to run twice.
//
...
console.log(`sending   ${fmt(TREASURY_STAGING_AMOUNT)} (200M treasury + 400M pool inventory)`);
