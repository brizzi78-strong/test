# MAGR Launch Announcement (draft)
...
| `{{PAIR_URL}}` | DexScreener/Uniswap link to the MAGR/ETH pool | 4 |
...
>
> ⚠️ This is the only real MAGR. Scammers deploy lookalike tokens within
...
>    20% (50,000,000 MAGR) sits in a disclosed treasury wallet:
>    `{{TREASURY_ADDRESS}}`
...
> ---
>
> Nothing here is financial advice. MAGR is an experiment; only spend what
