...
Ready-to-upload package for verifying `MagerCoin` through Etherscan's web UI —
...
`MagerCoin.solc-input.json` is the solc **standard JSON input** for the
...
2. Fill the form:
   ...
   - License: **MIT**
3. Upload `MagerCoin.solc-input.json`.
4. If asked which contract, pick
   `project/contracts/MagerCoin.sol:MagerCoin`.
