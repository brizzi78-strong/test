...
Ready-to-upload package for verifying `CARD` through Etherscan's web UI —
...
`Card.solc-input.json` is the solc **standard JSON input** for the
...
2. Fill the form:
   ...
   - License: **MIT**
3. Upload `Card.solc-input.json`.
4. If asked which contract, pick
   `project/contracts/Card.sol:CARD`.
