...
Ready-to-upload package for verifying `HopeCoin` through Etherscan's web UI —
...
`HopeCoin.solc-input.json` is the solc **standard JSON input** for the
...
2. Fill the form:
   ...
   - License: **MIT**
3. Upload `HopeCoin.solc-input.json`.
4. If asked which contract, pick
   `project/contracts/HopeCoin.sol:HopeCoin`.
