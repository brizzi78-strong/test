...
Ready-to-upload package for verifying `Cardinal` through Etherscan's web UI —
...
`Cardinal.solc-input.json` is the solc **standard JSON input** for the
...
2. Fill the form:
   ...
   - License: **MIT**
3. Upload `Cardinal.solc-input.json`.
4. If asked which contract, pick
   `project/contracts/Cardinal.sol:Cardinal`.
