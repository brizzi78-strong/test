...
Ready-to-upload package for verifying `CP17` through Etherscan's web UI —
...
`CP17.solc-input.json` is the solc **standard JSON input** for the
...
2. Fill the form:
   ...
   - License: **MIT**
3. Upload `CP17.solc-input.json`.
4. If asked which contract, pick
   `project/contracts/CP17.sol:CP17`.
