...
Ready-to-upload package for verifying `Presence` through Etherscan's web UI —
...
`Presence.solc-input.json` is the solc **standard JSON input** for the
...
2. Fill the form:
   ...
   - License: **MIT**
3. Upload `Presence.solc-input.json`.
4. If asked which contract, pick
   `project/contracts/Presence.sol:Presence`.
