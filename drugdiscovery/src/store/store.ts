...
export function createInMemoryStore(): Store {
  return {
    programs: new InMemoryCollection<Program>(),
    targets: new InMemoryCollection<Target>(),
    compounds: new InMemoryCollection<Compound>(),
    screens: new InMemoryCollection<Screen>(),
  };
}
