...
export interface Store {
  ...
  templates: Collection<PacketTemplate>;
  packets: Collection<OnboardingPacket>;
}
...
export function createInMemoryStore(): Store {
  return {
    ...
    templates: new InMemoryCollection<PacketTemplate>(),
    packets: new InMemoryCollection<OnboardingPacket>(),
  };
}
