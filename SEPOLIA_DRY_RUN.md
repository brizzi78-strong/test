...
`PresenceModule#Presence - 0xAB12...`.
**Record that address.**
...
It sends exactly 50,000,000 HERE and prints the transaction link — open it,
...
On the real day you'll do this in the Uniswap website (pair 200M HERE with
