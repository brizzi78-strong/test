...
### 1. Signing path — 12 points, one afternoon
...
### 2. State the real weakest item — 4 points, one paragraph
...
### 3. Regulatory posture — 4 points, a few thousand dollars
...
### 4. Make the token load-bearing, or delete it — 6 points, a design decision
...
### 5. Reserves — 6 points realistically, 12 in theory
...
## The realistic ceiling, and why 100 is the wrong target
