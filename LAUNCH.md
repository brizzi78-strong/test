...
| Before mainnet | Publish the coin site at **cp17.org** (already live from `cp17-site/`) and fill in the story section. The coin and the book are kept deliberately separate: nothing about CARD lives on thecardinalspromise.com, and cp17.org does not link to the book |
