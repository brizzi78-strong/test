...
export const INSTRUMENTS: readonly Instrument[] = [
  ...
  // Hope Coin — the workspace's own ERC-20. The mock base price is the
  // documented Uniswap launch price (3 ETH / 200M HOPE ≈ $0.000051, i.e. sub-cent);
  // configure the on-chain pool source and this becomes the live pool price.
  { symbol: 'HOPE', name: 'Hope Coin', kind: 'crypto', basePriceCents: 0.0051, volatilityBps: 1500 },
] as const;
