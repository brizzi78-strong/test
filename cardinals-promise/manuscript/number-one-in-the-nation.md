...
Or that's the version I like. What else the number took, I owe this book an answer.
...
Then it left me, quietly, the way it does when a family holds the door of a room and says: he waited for you.
...
- Whether the claim "what got me there was the question" is honest to how the number happened — or whether the number also took things this book shouldn't be proud of. If so, that sentence is where the confession goes.
