...
*A chapter from the pharma years — when the word I used to say for a living changed underneath me.*
...
The shortage took the drug out of their hands. The craze took the word out of their mouths.

I've sat at more than one table where this happened. Here is the one I carry. Somebody made the joke, the easy one, *everybody's on Ozempic now*, and everybody laughed, and one person at that table went quiet and reached for her water. She'd been on it three years. Pancreas, not red carpet. And she said nothing, because explaining would sound like what it always sounds like when you explain: an excuse.

She used to apologize for having the disease. Now she was hiding the treatment.

The woman in the hallway chapter feared the needle because it said *you failed.* The drug came along and for once the treatment didn't feel like a sentence. Then the craze made the same pen say *you cheated.* Verdict to verdict, and the medicine in between never changed.
...
That one, I'd like back.

---

## Details to confirm or replace (Rob)

- The real first time you heard the drug used as a punchline — was it the awards show, a patient's family, a colleague? The couch scene is a stand-in.
- The dinner-table moment is explicitly a composite ("pick your own") — if you witnessed a real version, put it here and the chapter sharpens; if not, the composite framing can stay but should stay honest about being one.
- The closing regret ("I didn't say it") — true of you? Only keep it if it is; it's the chapter's confession and can't be borrowed.
- Whether Hope's one-line cameo stays (she has her own chapter) or goes.
- The Denmark beat: the widely reported 2023 fact is that Novo's *market value* passed Denmark's annual GDP (stock vs. yearly output — the comparison everyone made, but worth keeping the "on paper" hedge).
- Chapter order: this assumes it runs after the hallway chapter and alongside/after the shortage.
