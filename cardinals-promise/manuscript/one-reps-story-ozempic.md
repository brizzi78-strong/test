...
*One rep's story of how he sold Ozempic — a scene from the pharma years.*

> **Draft scene — for Rob's review.** The shape of this story is built from
> your real arc (Novo Nordisk, learning to show up in rooms, the road to
> hospice). The specific office, doctor, and patient are stand-ins. Replace
> them with the real ones — the real moment will always beat the drafted one.
> This draft has been through a three-reviewer panel (craft, pharma
> authenticity, mission); the report is in
> `reviews/ozempic-scene-panel-report.md`. A list of details to swap is at
> the bottom.
...
- The real office, town, and year — re-dated to winter 2023 per your Aug 2021 start ("a year and a half in" holds); the drafted New Jersey setting was cut (your territory geography — Florida by the #1 era — is yours to fix).
