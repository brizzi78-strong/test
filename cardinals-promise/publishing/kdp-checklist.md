...
| Book cover | `kdp-cover-wrap.pdf` | One-piece wrap, 17.6509 × 11.25 in with 0.125" bleed; spine 0.4009" (178 pages × 0.002252", white paper); barcode zone left white for KDP |
...
- [ ] **Cover wrap regeneration pending** — the new navy design was adopted, but the wrap PDF still needs the designer's print-resolution front art (the shared preview is ~90dpi at wrap size; KDP needs 300dpi) and a rebuild to the real spine width (0.4009"). Send the high-res file.
