...
10. **Pricing — target list prices (Rob, July 2026): paperback $19.99, hardcover $29.99.** Paperback royalty is a flat **60% of list − printing cost**. The catch is printing cost, which depends entirely on the color tier you pick in step 9:
    - **Premium color** (8.5×11, 208 pp): print cost ≈ **$15.41/copy**. At $19.99 that's `0.60 × 19.99 − 15.41 =` **−$3.42 — a LOSS on every paperback.** To make premium color work you'd need a list around **$39.99–$44.99**.
    - **Standard color** (KDP's newer, cheaper color tier — still full color, slightly less saturated): print cost ≈ **$6.15/copy**. At $19.99 that's `0.60 × 19.99 − 6.15 =` **≈ $5.84 royalty.** This is the tier that makes **$19.99 hold.**
    - **Decision needed:** to keep $19.99, print the color interior in **standard color**, not premium. The color-coding system still prints in full color — you're trading a little vividness for a price customers will actually pay. (Confirm the live numbers on KDP's own calculator before you publish; Amazon updates print costs.)
    - Note: high-ink-coverage color interiors can be ineligible for Expanded Distribution; the IngramSpark route below covers bookstores anyway.
