...
1086×1448 px) is a **preview/mockup — about 128 DPI at 8.5×11, below print
...
5334×3375 px). Its aspect (0.75) is close to the 8.5×11 trim, but it still
needs a true high-res export. (The prior clean-title cover is kept as
`cover-clean-v1.jpeg` if the crossout is ever reconsidered.)
