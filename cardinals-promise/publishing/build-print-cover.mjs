...
//    Target: 17.8907 x 11.25 in @ 300 DPI  ->  5334 x 3375 px
// =====================================================================
{
  const W = Math.round(17.8907 * DPI); // 5334
  ...
  await page.close();
  await rasterToPdf(`${SCR}/wrap-flat.png`, 17.8907, 11.25, `${PUB}/kdp-cover-wrap-print.pdf`);
  console.log(`WRAP  -> ${W}x${H}px  =>  kdp-cover-wrap-print.pdf (17.8907 x 11.25 in)`);
}
