...
**Design 3b: The 2018 Tesla phase-out as a low-salience control event.** Tesla passed the 200,000-vehicle per-manufacturer threshold in the quarter ending September 30, 2018, and told customers to order by October 15, 2018 to take delivery by year end and secure the full $7,500 before the step-down to $3,750. That is a structurally similar deadline event, seven years earlier, affecting one manufacturer rather than the whole market, under the pre-transfer regime in which the credit was deferred, liability-limited, and invisible at the point of sale.

Comparing the two bunching episodes isolates the effect of *salience* on deadline response. If the 2025 pile-up is proportionally larger than the 2018 pile-up, after controlling for the size of the affected market and the magnitude of the loss, the difference is attributable to the credit having been made immediate and conspicuous in the interim. That is close to a direct test of this dissertation's central claim, and unlike Designs 2 and 3 it requires only monthly delivery data that already exists.

The asymmetry to handle: the 2018 deadline was Tesla's own, self-imposed to manage production against a December 31 placed-in-service requirement, and was therefore softer and partly promotional. The 2025 deadline was statutory. Chapter 11 §11.4.6 documents both.
