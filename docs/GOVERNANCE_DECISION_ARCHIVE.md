# Governance decision archive — superseded and historical

> **Not current policy.** This file preserves earlier analysis, proposals, retired names,
> and contradictory decision snapshots for audit history. Current policy lives only in
> `GOVERNANCE_AND_FOUNDER_ECONOMICS.md`. References below to HOP, Hope Coin, alternate
> domains, book bundles, fees, entities, boards, grants, or launch mechanics may be obsolete.

# Historical governance and founder economics
