...
The threshold question is whether offers and sales of CP17 are
...
**What this means for CP17's design** (to verify with counsel): the launch
...
CP17 is neither asset-referenced nor e-money, so Title II ("crypto-assets
