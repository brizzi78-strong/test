# Legal Briefing — Hope Coin (HOPE) Token Launch
...
The threshold question is whether offers and sales of HOPE are
...
**What this means for HOPE's design** (to verify with counsel): the launch
...
HOPE is neither asset-referenced nor e-money, so Title II ("crypto-assets
