# Legal Briefing — Presence (HERE) Token Launch
...
The threshold question is whether offers and sales of HERE are
...
**What this means for HERE's design** (to verify with counsel): the launch
...
HERE is neither asset-referenced nor e-money, so Title II ("crypto-assets
