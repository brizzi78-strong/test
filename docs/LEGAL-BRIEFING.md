# Legal Briefing — Hope Coin (HOP) Token Launch
...
The threshold question is whether offers and sales of HOP are
...
**What this means for HOP's design** (to verify with counsel): the launch
...
HOP is neither asset-referenced nor e-money, so Title II ("crypto-assets
