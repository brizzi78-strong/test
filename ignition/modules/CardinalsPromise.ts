...
/**
 * Deploys the Cardinals Promise (CARD) token. The full 1B supply is minted to the
 * deployer; the flat immutable 2% fee accrues to the treasury address given
 * as a parameter — on mainnet this MUST be the published treasury wallet, passed via
 ...
 *     --parameters '{"CardinalsPromiseModule": {"treasury": "0xTREASURY..."}}'
 */
