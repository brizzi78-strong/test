...
| **Cardinal Job Search — outreach copilot** | `jobsearch/` | A private, offline single-page app for job hunting: track applications through a pipeline, generate personalized LinkedIn messages (connection notes, follow-ups, referral asks, thank-yous) ready to copy and send, and get a daily follow-up worklist. Drafts and tracking are automated; you hit send — no bots touch your LinkedIn account (see `jobsearch/README.md`) |
