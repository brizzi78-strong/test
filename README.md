...
| **Cardinal Scout — book scouting console** | `scout/` | Constantly finding the books the world wants to buy: a demand catalog ranked by a 0–100 score, an appraisal engine that turns ISBN + condition + asking price into a buy/pass verdict with the margin math shown, and an inventory tracked from bought → listed → sold profit (see `scout/README.md`) |
