...
| **Card (CARD) token** | `contracts/`, `test/`, `verification/`, `site/` | Fixed-supply ERC-20 with a complete launch kit ([below](#cp-coin-platform-17-cp17-token)) |
...
ignition/modules/Card.ts       # Hardhat Ignition deployment module
