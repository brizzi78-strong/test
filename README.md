...
| **Invest — trading app** | `invest/` | A usable single-page trading app (home/portfolio, browse, watchlist, orders, buy/sell) backed by a backend-for-frontend that proxies to the Trading service and opens to one paper-trading account (see `invest/README.md`) |
