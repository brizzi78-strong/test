...
| **AidFinder — free money for college** | `aidfinder/` | Automated college-funding finder: a five-minute student profile matched against a curated catalog of grants, scholarships, tax credits, and employer/military benefits — with a computed Pell estimate, a deadline-ordered action plan, and an application tracker. Finds and schedules the money; never submits applications for you (see `aidfinder/README.md`) |
